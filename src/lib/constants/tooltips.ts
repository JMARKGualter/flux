// ==================== TOOLTIP DEFINITIONS ====================
export const meshTooltips: Record<string, string> = {
  // Full Breadboard
  ...
  //TRIOE Board
  'Invis': 'D35 - SPIIO6, GPIO35, FSPID, SUBSPID',
  'Invis001': 'D36 - SPIIO7, GPIO36, FSPICLK, SUBSPICLK',
  'Invis002': 'D37 - SPIDQS, GPIO37, FSPIQ, SUBSPIQ',
  'Invis003': 'D38 - GPIO38, FSPIWP, SUBSPIWP, RGB LED',
  'Invis004': 'D39 - MTCK, GPIO39, CLK_OUT3, SUBSPICS1',
  'Invis005': 'D40 - MTDO, GPIO40, CLK_OUT2',
  'Invis006': 'D41 - MTDI, GPIO41, CLK_OUT1',
  'Invis007': 'D42 - MTMS, GPIO42',
  'Invis008': 'RX - U0RXD, GPIO44, CLK_OUT2',
  'Invis009': 'TX - U0TXD, GPIO43, CLK_OUT1',
  'Invis010': 'D2 - RTC_GPIO2, GPIO2, TOUCH2, ADC1_CH1',
  'Invis011': 'D1 - RTC_GPIO1, GPIO1, TOUCH1, ADC1_CH0',
  'Invis012': '3V3.1 - 3.3 V power supply',
  'Invis013': '5V.1 - 5 V power supply',
  'Invis014': 'GND.1 - Ground',
  'Invis015': 'D48 - GPIO48, SPICLK_N, SUBSPICLK_N_DIFF',
  'Invis016': 'D47 - GPIO47, SPICLK_P, SUBSPICLK_P_DIFF',
  'Invis017': 'D21 - RTC_GPIO21, GPIO21',
  'Invis018': 'D14 - 	RTC_GPIO14, GPIO14, TOUCH14, ADC2_CH3, FSPIWP, FSPIDQS, SUBSPIWP',
  'Invis019': 'D10 - RTC_GPIO10, GPIO10, TOUCH10, ADC1_CH9, FSPICS0, FSPIIO4, SUBSPICS0',
  'Invis020': 'D9 - RTC_GPIO9, GPIO9, TOUCH9, ADC1_CH8, FSPIHD, SUBSPIHD',
  'Invis021': 'D3 - RTC_GPIO3, GPIO3, TOUCH3, ADC1_CH2',
  'Invis022': 'D8 - RTC_GPIO8, GPIO8, TOUCH8, ADC1_CH7, SUBSPICS1',
  'Invis023': 'D7 - RTC_GPIO7, GPIO7, TOUCH7, ADC1_CH6',
  'Invis024': 'D6 - RTC_GPIO6, GPIO6, TOUCH6, ADC1_CH5',
  'Invis025': 'D5 - RTC_GPIO5, GPIO5, TOUCH5, ADC1_CH4',
  'Invis026': 'D4 - RTC_GPIO4, GPIO4, TOUCH4, ADC1_CH3',
  'Invis027': '3V3.2 - 3.3 V power supply',
  'Invis028': '5V.2 - 5 V power supply',
  'Invis029': 'GND.2 - Ground',
};