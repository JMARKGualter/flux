  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
      ...
      <div className="space-y-4 sm:space-y-6 text-center lg:text-left px-2 sm:px-4 lg:px-0 lg:pl-6">
        ...
        <p className={`text-sm sm:text-base md:text-lg lg:text-xl ${isDark ? 'text-gray-300' : 'text-gray-700'} max-w-2xl mx-auto lg:mx-0`}>
        ...
        <div className="flex flex-col items-center lg:items-start gap-3 sm:gap-4">
          ...
          <Link
            href="/learn"
            className={`flex items-center justify-center gap-2 w-full sm:w-[260px] md:w-[280px] lg:w-[260px] px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg transition-all shadow-lg ${
              isDark 
          ...
          <div className="w-full">
            ...
            <div className="relative flex justify-center lg:justify-start">
              <button
                ...
                className={`flex items-center justify-center gap-2 w-full sm:w-[260px] md:w-[280px] lg:w-[260px] px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg transition-all cursor-not-allowed ${
                  isDark 
      ...
      <div className="relative w-full mt-6 lg:mt-0">
        ...
        <div className={`relative bg-gradient-to-br ${isDark ? 'from-blue-950/50 to-blue-900/30' : 'from-blue-100/50 to-blue-50/30'} rounded-2xl border ${isDark ? 'border-blue-500/30' : 'border-blue-300/30'} p-3 sm:p-4 md:p-6 lg:p-8 backdrop-blur-sm`}>
          ...
          <div className="mt-2 sm:mt-3 md:mt-4 text-center">
            <p className={`text-[10px] sm:text-xs md:text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Interactive 3D Logo</p>
            <p className={`text-[8px] sm:text-[10px] md:text-xs ${isDark ? 'text-gray-500' : 'text-gray-500'} mt-1`}>Click and drag to rotate</p>
          </div>
          <p className="absolute bottom-1 right-1 sm:bottom-2 sm:right-2 text-[6px] sm:text-[8px] md:text-[10px] text-gray-500">MADE WITH LOVE FOR THE TRIOE COMMUNITY</p>
        </div>
      </div>
      ...
      {showVrTooltip && (
        ...
        >
          <div className={`px-2 py-1 rounded-lg text-[10px] sm:text-xs font-medium whitespace-nowrap shadow-lg animate-fade-in ${
            isDark 
