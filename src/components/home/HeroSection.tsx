...
export function HeroSection({ isDark }: HeroSectionProps) {
  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
      {/* Text Content */}
      <div className="space-y-6 text-center lg:text-left px-4 lg:px-0 lg:pl-6">
        <h1 className={`text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 lg:mb-6 bg-gradient-to-r ${isDark ? 'from-white via-blue-200 to-blue-400' : 'from-black via-blue-900 to-blue-600'} bg-clip-text text-transparent`}>
        ...
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="mt-6 lg:mt-8 w-full">
            <p className={`text-sm mb-3 text-center lg:text-left ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
